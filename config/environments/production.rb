...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "damagereclaim_#{Rails.env}"
  ...
  ###############################################################
    ...
    WickedPdf.config = { exe_path: '/usr/local/bin/wkhtmltopdf' } if Rails.env.production? # => This is only valid for production environment

  ###############################################################
  ###############################################################

    config.active_job.queue_adapter = :inline if Rails.env.staging? # => For Heroku issues
