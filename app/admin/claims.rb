...
if Object.const_defined?('ActiveAdmin')
  ...
  ActiveAdmin.register Claim do
    ...
    member_action :pdf, method: :get do
      render pdf: "claim-#{resource.id}.pdf", title: "DamageReclaim/#{resource.id}", template: "application/claim", show_as_html: true, locals: { items: %w(insurance signed shown inspected employee noted acknowledge report subsequent card invoice repair method additional vat) }
    end
